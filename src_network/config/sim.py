def apply_sim_config(cfg):
    ...
    # src_network diverges from src/ here: label outputs with the 10-cell
    # per resident population network size instead of the 1-cell microcircuit.
    cfg.simLabelBase = "CA1_10"
